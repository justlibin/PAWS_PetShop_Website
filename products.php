...
<html>
  <?php include "includes/css_header.php";
   ...
   ?>
<body style="background-image: url('images/husky1.jpg'); 
      ...
      <?php 
        ...
        while($row=mysqli_fetch_assoc($result))
        {
          echo '<div class="col-md-3">
                  <div class="pet-tab">
                    <img src="images/'.$row['pet_image'].'" class="img-size curve-edge">
            ...
            echo '<div class="col-md-12">
                    <div class="row list hover-pink">
                      ...
                      <div class="col-md-6">
                        ...
                        <img src="images/'.$row1['pet_image'].'" class="img-size-xs">
                        </a>
                      </div>
